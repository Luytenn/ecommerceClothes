...
<!-- Mirrored from demo.bootstrapious.com/hub/1-4-2/detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 30 Jan 2020 17:03:04 GMT -->
<head>
    <meta charset="utf-8">
  ...
  <body>
      ...
      <%@include file="../WEB-INF/navbar.jsp" %>
       <c:forEach items="${sessionScope.cartDetail}" var="pro">
    <!-- Hero Section-->
        ...
        <div class="row">
          <div class="product-images col-lg-6">
            ...
            <div data-slider-id="1" class="owl-carousel items-slider owl-drag">
              <div class="item"><img src="foto/${pro.p.img}" alt="shirt"></div>
          ...
          <div class="details col-lg-6">
            <div class="d-flex align-items-center justify-content-between flex-column flex-sm-row">
              ...
              <!-- EDITAR AQUI PARA  -->
              	...
              	<li class="list-inline-item current">${pro.p.precio}</li>
            ...
            <ul class="CTAs list-inline">
              <li class="list-inline-item"><a href="Cart?id=${pro.p.webid}&action=order" class="btn btn-template wide"> <i class="icon-cart"></i>Add to Cart</a></li>
...
<!-- Mirrored from demo.bootstrapious.com/hub/1-4-2/detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 30 Jan 2020 17:03:08 GMT -->
</html>